    ...
    <div className="bg-background text-on-background min-h-screen flex items-center justify-center p-4">
      <main className="w-full max-w-md bg-surface-container-lowest rounded-[1.5rem] p-8 shadow-[0_24px_48px_-12px_rgba(26,27,31,0.06)] relative overflow-hidden">
        ...
        <form className="relative z-10 space-y-6">
          <div className="space-y-4">
            <div className="relative group">
              <label className="font-label text-sm font-medium text-on-surface-variant uppercase tracking-wider block mb-1.5 pl-1" htmlFor="alt-email">Email</label>
              <div className="relative flex items-center">
                ...
                <input
                  className="w-full bg-surface-container-low text-on-surface rounded-xl pl-12 pr-4 py-3.5 border border-transparent focus:border-primary/40 focus:ring-0 transition-colors placeholder:text-outline-variant outline-none"
                  id="alt-email"
                  name="email"
            ...
            <div className="relative group">
              <div className="flex items-center justify-between mb-1.5 pl-1 pr-1">
                <label className="font-label text-sm font-medium text-on-surface-variant uppercase tracking-wider block" htmlFor="alt-password">Password</label>
          ...
          <button
            className="w-full bg-gradient-to-br from-primary to-primary-container text-on-primary font-medium rounded-xl py-3.5 flex items-center justify-center gap-2 hover:shadow-[0_12px_24px_-8px_rgba(0,62,199,0.3)] transition-shadow"
            type="submit"
          >
            Log In
        ...
        <p className="relative z-10 text-center mt-8 text-on-surface-variant font-body">
          ...
          <a className="font-medium text-primary hover:text-primary-container transition-colors" href="#">Sign up</a>
        </p>
      </main>
    </div>
  );
